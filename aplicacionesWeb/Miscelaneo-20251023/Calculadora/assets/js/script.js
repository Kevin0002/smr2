  ...
  if (primero) {
    ...
    if (n == "." && n1.includes(".")) {
      document.getElementById("error").innerHTML =
        "No puedes introducir dos puntos en un número<br>";
    } else {
      n1 += n;
...
function operacion(n) {
  if (oprcn == 0) {
    ...
    document.getElementById("error").innerHTML =
      "No puedes realizar más de una operación a la vez, primero resuelve el cálculo y luego continuas haciendo las operaciones<br>";
  }
  cE();
}
...
function resultado() {
  ...
  if (n2 != "" && oprcn != 5) {
    ...
    document.getElementById("error").innerHTML =
      "Debes introducir un segundo número para realizar el cálculo<br>";
  }
  cE();
}
...
function manejarTecla(event) {
  ...
  if (primero) {
    ...
    // Si pulsa Enter → calcular
      ...
      document.getElementById("error").innerHTML =
        "Necesitas seleccionar un operador para continuar";
      //resultado();
      cE();
    }
    ...
    // Si pulsa Enter → calcular
      ...
      if (n2 == "") {
        document.getElementById("error").innerHTML =
          "Necesitas añadir un segundo número para realizar la operación";
      } else {
        resultado();
      }
      cE();
...
function cE() {
  ...
  if (oprcn == 5) {
    ...
    document
      .getElementById("raiz")
      .setAttribute("class", "botones-desactivados");
    ...
    document
      ...
      .setAttribute("onclick", "desactivarOperacion()");
    return true;
  } else {
    document.getElementById("limpiar").innerHTML = "C";
    document
      .getElementById("limpiar")
      .setAttribute("onclick", "limpiarPantalla()");
